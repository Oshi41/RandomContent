...
public class InfiniteFurnaceBlock extends AbstractFurnaceBlock {
    public InfiniteFurnaceBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void openScreen(World world, BlockPos pos, PlayerEntity player) {
        ...
        if (blockEntity instanceof InfiniteFurnaceBlockEntity) {
    ...
    public @Nullable BlockEntity createBlockEntity(BlockView world) {
        return new InfiniteFurnaceBlockEntity();
    }
